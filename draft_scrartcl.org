...
#+LATEX_CLASS_OPTIONS: [version=last,draft=false, paper=A4,portrait,twoside=true,twocolumn=false,fontsize=11,BCOR=20mm,DIV=calc,pagesize=auto,titlepage=false,mpinclude=true,open=right,captions=tablesignature,captions=figuresignature]
