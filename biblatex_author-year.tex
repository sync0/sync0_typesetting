...
\addbibresource{~/Gdrive/org/references/bibliography.bib}
\addbibresource{~/Gdrive/org/references/doctorat.bib}
%% \addbibresource{~/Gdrive/org/references/memoire.bib}
